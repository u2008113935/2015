		...
		*/
		...
		Select 			
			...
			*/		
			--NombreMes =DATENAME(month, FechaAprob) 
			cTipActSis,Nivel,cCodCarPer,cDesCarPer
			,CantiCF=count(CodigoCartaFianza)
			,FechaAprob 
		...
		from #tab1 
		Where CESTCARFIA in ('K','G')
			and FechaAprob >= '2015-06'
			and FechaAprob <= '2015-08'
		Group By cTipActSis,Nivel,cCodCarPer,cDesCarPer,FechaAprob
		Order BY FechaAprob
