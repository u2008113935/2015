...
*/
	...
	Declare @x_cCodCliente CHAR(14)
	Set @x_cCodCliente  = '107014385118'
	...
	FROM CMACHYOCLI_MANIANA.DBO.CLIMGarCliente A  
		LEFT JOIN CMACHYOCLI_MANIANA.DBO.CliMGarFisHipCli B
			ON A.CCODCLIENTE = B.CCODCLIENTE 
				AND A.CCODGARCLI = B.CCODGARCLI
		LEFT JOIN CMACHYOCLI_MANIANA.DBO.CliMGarTitValCli C
			ON A.CCODCLIENTE = C.CCODCLIENTE 
				AND A.CCODGARCLI = C.CCODGARCLI
		LEFT JOIN CMACHYOCLI_MANIANA.DBO.CliMGarPerCli D	 
