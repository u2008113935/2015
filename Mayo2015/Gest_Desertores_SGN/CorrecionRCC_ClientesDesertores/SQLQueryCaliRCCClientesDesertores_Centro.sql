...
--drop table ZONACENTRO
select len(COD_SBS1) from ZONACENTRO

--*********************************INDEXANDO****************************************************
CREATE NONCLUSTERED INDEX ZONACENTRO_CODIGO_CLIENTE_IXN ON ZONACENTRO(CODIGO_CLIENTE)
CREATE NONCLUSTERED INDEX ZONACENTRO_COD_SBS1_IXN ON ZONACENTRO(COD_SBS1)
CREATE NONCLUSTERED INDEX ZONACENTRO_CODIGO_CREDITO_IXN ON ZONACENTRO(CODIGO_CREDITO)
--------------------****************************************************************************
...
-------------------CURSOR-------------------------------------------------
	...
	@nov2014 char(12),@oct2014  char(12), @set2014 char(12)
		Declare cClienteRCC CURSOR FOR					
			select COD_SBS1 from ZONACENTRO (NOLOCK) 
