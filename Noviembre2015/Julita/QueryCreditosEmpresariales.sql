	...
	/*
		...
		Extracción de una cartera empresarial con los siguientes características:
		Moneda: soles
		Tipo de crédito micro y pequeña empresa
		Solo desembolsos a partir del 24/07/15 hasta el 31/10/15
		Plazo: no mayor a 24 cuotas
		Modalidad: cualquiera
		Calificación: Normal
		Personas naturales so jurídicas
		...
		TEA
		TEM
		Fecha del desembolso, Suproducto, dirección del cliente
		Distrito
		Provincia
		Departamento.
	...
	*/
	...
	Select * into #tab01 from (
			Select 		
					...
					,CodLC = CRE.nNroLinFin, LIN.cCodTipCre,LineaCredito =LIN.cDesLinFin
		...
		-- del 24/07/15 hasta el 31/10/15
