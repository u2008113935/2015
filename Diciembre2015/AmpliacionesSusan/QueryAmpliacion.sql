		...
		Select * into #tab01 from (
			...
			FROM [KPYMCRECONVEN] CRE (NOLOCK)		
					...
					INNER JOIN [KPYTSUBTIPCRE] STC
						...
						AND CRE.cCodSubPro = STC.cCodSubPro and STC.lEstado = '1'e
				...
				WHERE CRE.cEstCreCon = 'F'														
					...
					OR LEFT(CAST(CRE.dFecDesCre AS DATE),10)	<=	'2015-11-30')
					...
					/*
						...
						SELECT * FROM #tab01
						WHERE FechaDesembolso <= '2015-11-30'		AND		FechaDesembolso >= '2015-06-01'
		...
		*/
		...
		Select * into #tab03 from (	
			...
			GROUP BY B.cCodCtaCre,B.cCodPlaPag,B.cNumCuoPla,B.dFecVenPag,B.dFecPagCuo,B.NDIAVENCUO,B.cCodEstCuo 
				...
				,A.EstadoCredito, A.cCodModCre, A.cDesModCre, A.cCodFueIng, A.FechaDesembolso, A.Anio
	...
	------------------------CURSOR-----------------------------------
		...
		Select * into #tab04 FROM 
			(Select top 1  
					...
					,EstadoCredito,cCodModCre,cDesModCre,cCodFueIng,FechaDesembolso,Anio,Mes,NombreMes
