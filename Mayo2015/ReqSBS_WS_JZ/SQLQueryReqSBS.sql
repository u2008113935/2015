...
WHERE CRE.cEstCreCon = 'F'	
	--AND CRE.cCodDesCre = 
	 AND 
	 (
	 (cDesSubCre	like '%CREDICASA%HABITACIONAL%' and lEstado = 1)
	 OR (cDesSubCre	= 'CREDICASA' and lEstado = 1)
	 OR (cDesSubCre	= 'MIVIVIENDA' and lEstado = 1)
	 OR (cDesSubCre	= 'TRABAJADORES' and lEstado = 1)
	 OR (cDesSubCre	= 'TECHO PROPIO' and lEstado = 1) 
	 )
	 ) as tmp99
