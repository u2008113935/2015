...
--drop table centrooriente
select len(COD_SBS1) from centrooriente

--*********************************INDEXANDO****************************************************
CREATE NONCLUSTERED INDEX centrooriente_CODIGO_CLIENTE_IXN ON centrooriente(CODIGO_CLIENTE)
CREATE NONCLUSTERED INDEX centrooriente_COD_SBS1_IXN ON centrooriente(COD_SBS1)
CREATE NONCLUSTERED INDEX centrooriente_CODIGO_CREDITO_IXN ON centrooriente(CODIGO_CREDITO)
--------------------****************************************************************************
...
-------------------CURSOR-------------------------------------------------
	...
	@nov2014 char(12),@oct2014  char(12), @set2014 char(12)
		Declare cClienteRCC CURSOR FOR					
			select COD_SBS1 from centrooriente (NOLOCK) 
