...
FROM [HYO00410].URIESGOS.dbo.URIRCCSAL808 A
...
--Extrae documento de identidad de los clientes
  ...
  INTO #tmpRCC01
  FROM [HYO00410].URIESGOS.dbo.URIRCCSAL808 A
  INNER JOIN [HYO00410].URIESGOS.dbo.URIRCCMAE808 B ON A.CCODSBS = B.CCODSBS
  INNER JOIN #tmpTotCliCMACHYO C ON A.CCODSBS = C.CCODSBS
