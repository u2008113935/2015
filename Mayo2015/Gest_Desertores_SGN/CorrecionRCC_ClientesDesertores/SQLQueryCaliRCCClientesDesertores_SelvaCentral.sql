select * from SELVA_CENTRAL
--drop table SELVA_CENTRAL
select len(COD_SBS1) from SELVA_CENTRAL

--*********************************INDEXANDO****************************************************
CREATE NONCLUSTERED INDEX SELVA_CENTRAL_CODIGO_CLIENTE_IXN ON SELVA_CENTRAL(CODIGO_CLIENTE)
CREATE NONCLUSTERED INDEX SELVA_CENTRAL_COD_SBS1_IXN ON SELVA_CENTRAL(COD_SBS1)
CREATE NONCLUSTERED INDEX SELVA_CENTRAL_CODIGO_CREDITO_IXN ON SELVA_CENTRAL(CODIGO_CREDITO)
--------------------****************************************************************************
...
-------------------CURSOR-------------------------------------------------
	...
	@nov2014 char(12),@oct2014  char(12), @set2014 char(12)
		Declare cClienteRCC CURSOR FOR					
			select COD_SBS1 from SELVA_CENTRAL (NOLOCK) 
