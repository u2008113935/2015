...
---------------------------------------------------------------------------------------
	...
	*/
	...
	Select 		
		...
		WHERE CRE.cEstCreCon in ('F','H','G','I')					
			and left(cast(CRE.dFecDesCre as date),10) >= '2015-11-01'
			and left(cast(CRE.dFecDesCre as date),10) <= '2015-11-30'				
	...
	WHERE PREN.cCodEstKpr 
			in ('D','A','R','G','H')									
		and left(cast(PREN.dFecCreKpr as date),10) >= '2015-11-01'
		AND left(cast(PREN.dFecCreKpr as date),10) <= '2015-11-30'			
